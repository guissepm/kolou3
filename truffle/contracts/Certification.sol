...
contract Certification {
    ...
    function generateCertificate(
        ...
        certificates[byte_id] = Certificate(_candidate_name, _org_name, _course_name, _ipfs_adr, _expiration_date);
    ...
    function getData(string memory _id) public view returns(string memory, string memory, string memory, string memory, uint256) {
        ...
        return (temp.candidate_name, temp.org_name, temp.course_name, temp.ipfs_adr, temp.expiration_date);
    }
}